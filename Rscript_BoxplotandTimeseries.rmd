...
```{r}
commonTitle<-""
dataSource<-"\nデータ出所:内閣府"# Federal Reserve Bank of St. Louis
...
cat(",initComplete: function () {",file=htmlFile,append=T)
cat("this.api().columns().every( function () {",file=htmlFile,append=T)
cat("var column = this;",file=htmlFile,append=T)
cat("var select = $('<select><option value=\"\"></option></select>')",file=htmlFile,append=T)
cat(".appendTo( $(column.footer()).empty() )",file=htmlFile,append=T)
cat(".on( 'change', function () {",file=htmlFile,append=T)
cat("var val = $.fn.dataTable.util.escapeRegex(",file=htmlFile,append=T)
cat("$(this).val()",file=htmlFile,append=T)
cat(");",file=htmlFile,append=T)
cat("column",file=htmlFile,append=T)
cat(".search( val ? '^'+val+'$' : '', true, false )",file=htmlFile,append=T)
cat(".draw();",file=htmlFile,append=T)
cat("} );",file=htmlFile,append=T)
cat("column.data().unique().sort().each( function ( d, j ) {",file=htmlFile,append=T)
cat("select.append( '<option value=\"'+d+'\">'+d+'</option>' )",file=htmlFile,append=T)
cat("} );",file=htmlFile,append=T)
cat("} );",file=htmlFile,append=T)
cat("}",file=htmlFile,append=T)
#Individual column searching part  
...
cat(".dataTable();",file=htmlFile,append=T)
#calStat part  
