...
funMaintitle<-function(){
  ...
  mainTitle<-gsub("完全失業率","完全失業率(%)",mainTitle)
...
```{r}
commonTitle<-""
dataSource<-"\nデータ出所:Federal Reserve Bank of St. Louis"# Federal Reserve Bank of St. Louis
...
cat("最新データは\"数表リスト\"( http://am-consulting.co.jp/?p=1914 )から確認ください<br>",file=htmlFile,append=T)
#calStat part  
...
cat("<td style=\"text-align:right\" bgcolor=\"#F5F5F5\">プラス値</td>",file=htmlFile,append=T)
