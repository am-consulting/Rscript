...
```{r}
commonTitle<-""
dataSource<-"\nデータ出所:株式会社東京証券取引所"# Federal Reserve Bank of St. Louis
...
cat("\n<table width=\"100%\"><thead><tr><th width=\"15%\">Target</th><th width=\"85%\">Search text</th><th>Regex</th></tr></thead><tbody>\n",file=htmlFile,append=T)
