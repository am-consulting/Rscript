```{r}
period<-c("03/02～03/06","03/09～03/013")
...
for(ppp in 1:3){
  ...
  g1<-g1+geom_text(data=balance.dataset,aes(x=investor,y=lastWeek/2,label=comma(round(lastWeek,2))),angle=90,vjust=0.5,hjust=0,size=6,family="Meiryo") 
  ...
  g2<-g2+geom_text(data=balance.dataset,aes(x=investor,y=thisWeek/2,label=comma(round(thisWeek,2))),angle=90,vjust=0.5,hjust=0,size=6,family="Meiryo") 
