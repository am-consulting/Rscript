...
htmlFile<-paste("elninoMonthlyDiff.html",sep=""),
htmlFile<-paste("elninoMonthlyTempDiff.html",sep="")
) 
cat("
<!DOCTYPE HTML>
<html>
...
cat("<div align=\"center\"><b>",title[[1]],"</b><br>データ出所：気象庁</div>",file=htmlFile,append=T)
for(rrr in 1:length(origData)){
  grandData<-NULL
  header<-NULL
