...
#      graph.html<-paste(js.title[[iii]],data.id,id,".html",sep="")
      graph.html<-paste(js.title[[iii]],data.id,".html",sep="")
...
#        png.file<-paste(js.title[[iii]],data.id,id,ppp,iii,ttt,".png",sep="")
        png.file<-paste(js.title[[iii]],data.id,ppp,iii,ttt,".png",sep="")
...
#  png.file<-paste(js.title[[iii]],"msm",id,ppp,iii,qqqq,".png",sep="")
  png.file<-paste(js.title[[iii]],"msm",ppp,iii,qqqq,".png",sep="")
  png(file=png.file,width=1400,height=1200)
  par(ps=40)
  par(mar=c(9, 7, 15, 4))
...
csv.file.name<-paste(js.title[[iii]],ppp,iii,".csv",sep="")    
...
csv.id<-paste(js.title[[iii]],"csv",ppp,iii,sep="")
...
#  boxplot.html<-paste(js.title[[iii]],data.id,id,".html",sep="")
  boxplot.html<-paste(js.title[[iii]],data.id,".html",sep="")
...
#  unitroot.html<-paste(js.title[[iii]],data.id,id,ppp,iii,".html",sep="")  
  unitroot.html<-paste(js.title[[iii]],data.id,ppp,iii,".html",sep="")  
...
#  cat(paste("\n$('#",data.id,id,ppp,iii,"').html('<pre>' + data + '</pre>');",sep=""),file=js.file.name.unitroot,append=T)
  cat(paste("\n$('#",data.id,ppp,iii,"').html('<pre>' + data + '</pre>');",sep=""),file=js.file.name.unitroot,append=T)
...
#  png.file<-paste(js.title[[iii]],data.id,id,ppp,iii,".png",sep="")    
  png.file<-paste(js.title[[iii]],data.id,ppp,iii,".png",sep="")    
  png(file=png.file,width=1400,height=1200)
  par(mar=c(7, 5, 5, 5))
  if(monthly==1){
...
#  cat(paste("document.write('<div id=\"",data.id,id,ppp,iii,"\"></div>\');\n",sep=""),file=js.file.root.list,append=T)
  cat(paste("document.write('<div id=\"",data.id,ppp,iii,"\"></div>\');\n",sep=""),file=js.file.root.list,append=T)
...
#  acf.html<-paste(js.title[[iii]],data.id,id,".html",sep="")   
  acf.html<-paste(js.title[[iii]],data.id,".html",sep="")   
...
#  forecast.html<-paste(js.title[[iii]],data.id,id,".html",sep="")
  forecast.html<-paste(js.title[[iii]],data.id,".html",sep="")
...
png.file<-paste(js.title[[iii]],data.id,"future",ppp,iii,".png",sep="")    
png(file=png.file,width=1400,height=1200) 
par(mar=c(5, 7, 15, 4))
par(cex.main=4,cex.lab=2,cex.axis=2)
if(monthly==1){
...
png.file<-paste(js.title[[iii]],data.id,"test",ppp,iii,".png",sep="")    
png(file=png.file,width=1400,height=1200) 
par(mar=c(5, 7, 18, 4))
par(cex.main=4,cex.lab=2,cex.axis=2)
...
#  return.html<-paste(js.title[[iii]],data.id,id,".html",sep="")
  return.html<-paste(js.title[[iii]],data.id,".html",sep="")
...
png.file<-paste(js.title[[iii]],data.id,"qq",ppp,iii,".png",sep="")     
png(file=png.file,width=1400,height=1200) 
par(mar=c(5, 5, 14, 2))      
...
png.file<-paste(js.title[[iii]],data.id,"cdf",ppp,iii,".png",sep="")     
png(file=png.file,width=1400,height=1200)
par(mar=c(5, 5, 14, 2))     
...
#  png.file<-paste(js.title[[iii]],data.id,id,ppp,iii,rrrr,".png",sep="")     
  png.file<-paste(js.title[[iii]],data.id,ppp,iii,rrrr,".png",sep="")     
  png(file=png.file,width=1400,height=1200)       
...
#  garch.html<-paste(js.title[[iii]],data.id,id,".html",sep="")
  garch.html<-paste(js.title[[iii]],data.id,".html",sep="")
...
png.file<-paste(js.title[title.no],"cointeg",".png",sep="")
png(file=png.file,width=1400,height=1200) 
par(mar=c(7, 7, 10, 2))
par(ps=40)
