...
if(exe==1){
  ...
  ts.source[[1]]<-c("FRED",1,"CP0000EZ17M086NEST")# CP0000EZ17M086NEST CPIAUCSL
...
title.no<-1
js.title<-c("MANETARYBASEANDUNEMPLOYMENTRATEJAPAN")
priod.y<-10 #year
