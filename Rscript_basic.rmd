 ...
 if(length(dir(folder.path))!=0){
  for(fff in 1:length(dir(folder.path))){
   ...
   for(zzz in cnt.start:cnt){
    ...
    plot.type[[zzz]]<-substr(js.title[[zzz]],nchar(js.title[[zzz]]),nchar(js.title[[zzz]]))
...
#  ts.source[[1]]<-c("FRED",1,"PAYEMS","MANEMP","UNRATE","CPIAUCNS","HOUSTNSA","A191RL1Q225SBEA","AMBNS","M2V","CP0000EZ17M086NEST","EXJPUS")
