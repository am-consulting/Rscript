...
if(exe==1){
  ts.source<-list()
  ts.source[[1]]<-c("FRED",1,"DEXUSUK","DEXUSAL")# DCOILWTICO CPIAUCSL NIKKEI225 UNRATE CPIAUCSL GOLDAMGBD228NLBM DEXUSEU DEXUSUK DEXCAUS DEXBZUS DEXUSAL DEXMXUS DEXSFUS DEXUSNZ DEXJPUS SP500 HOUSTNSA DGS10 EXJPUS
...
####テスト用####  
  ...
  #future
    ...
    #test
      y.min<-min(tmp.forecast[,2])  
      y.max<-max(tmp.forecast[,2])  
