...
if(ppp==1 && chk.forecast==0){ 
  ...
  cat("\n\n$(function() {",file=js.file.name.forecast,append=T)
...
if(ppp==1 && chk.return==0){
  ...
  cat("\n\n$(function() {",file=js.file.name.return,append=T)
...
dev.off()
cat(paste("<img src=\"http://archive.am-consulting.co.jp/",png.file,add.ver,"\"", " alt=\"\" width=\"100%\">\n",sep=""),file=return.html,append=T)
cat("Caution:Return rates are calculated regardless of NSA or SA.",file=return.html,append=T)
}
}  
######################################returnfitting ######################################    
######################################  returnrank  ######################################
...
#javascript part
if(ppp==1 && chk.msm==0){  
  msm.html<-paste(js.title[[iii]],data.id,".html",sep="")
  js.file.name.msm<-paste(js.title[[iii]],".external09.js",sep="")
  cat("\n",file=msm.html,append=F)
  cat("\n",file=js.file.name.msm,append=F)
  if(dataset.type==1){
    chk.msm<-1
  }
  cat("\n\n$(function() {",file=js.file.name.msm,append=F)
  cat(paste("\n$.get('http://archive.am-consulting.co.jp/",msm.html,add.ver,"', function(data) {",sep=""),file=js.file.name.msm,append=T)
  cat(paste("\n$('#",data.id,"').html('<pre>' + data + '</pre>');",sep=""),file=js.file.name.msm,append=T)
  cat("\n});",file=js.file.name.msm,append=T)
  cat("\n});\n\n",file=js.file.name.msm,append=T) 
}      
#javascript part  
if(exe.msm==1){
cat("<div align=\"center\"><b>Markov Switching Models\npowered by R package 'MSwM' - msmFit()\n",file=msm.html,append=T)
x<-seq(1:nrow(tmp.1))    
...
cat(paste("\n<div align=\"center\"><b>",gettitle,"</b></div>"),file=msm.html,append=T)      
...
data.id<-"setar"
#javascript part
if(ppp==1 && chk.setar==0){  
  setar.html<-paste(js.title[[iii]],data.id,".html",sep="")
  js.file.name.setar<-paste(js.title[[iii]],".external010.js",sep="")
  cat("\n",file=setar.html,append=F)
  cat("\n",file=js.file.name.setar,append=F)
  if(dataset.type==1){
    chk.setar<-1
  }
  cat("\n\n$(function() {",file=js.file.name.setar,append=F)
  cat(paste("\n$.get('http://archive.am-consulting.co.jp/",setar.html,add.ver,"', function(data) {",sep=""),file=js.file.name.setar,append=T)
  cat(paste("\n$('#",data.id,"').html('<pre>' + data + '</pre>');",sep=""),file=js.file.name.setar,append=T)
  cat("\n});",file=js.file.name.setar,append=T)
  cat("\n});\n\n",file=js.file.name.setar,append=T) 
}      
#javascript part  
if(exe.setar==1){
cat("<div align=\"center\"><b>Self-Exciting Threshold AutoRegressive models\npowered by R package 'tsDyn' - setar()<b></div>\n",file=setar.html,append=T)
cat("Caution:\nThe time series data may have unit roots.\n",file=setar.html,append=T)
cat(paste("\n<div align=\"center\"><b>",gettitle,"</b></div>"),file=setar.html,append=T)      
