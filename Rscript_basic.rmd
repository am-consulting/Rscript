...
#javascript part
    if(ppp==1 && chk.j==0){
      ...
      graph.html<-paste(js.title[[iii]],"graph",id,".html",sep="")
...
#javascript part    
    for(ttt in ttt.range){
      ...
      if(nrow(tmp.1)!=0){
        ...
        png.file<-paste(js.title[[iii]],"graph",id,ppp,iii,ttt,".png",sep="")
...
if(ppp==1 && chk.box==0){
  boxplot.html<-paste(js.title[[iii]],"boxplot",id,".html",sep="")
...
if(nrow(subset(tmp.unitroot,tmp.unitroot[,2]!=0))!=0){
  unitroot.html<-paste(js.title[[iii]],"unitroot",id,ppp,iii,ttt,".html",sep="")
  ...
  write(tmp.unitroot.result,unitroot.html,append=T)
#javascript part for unitroot
  data.id<-paste("unitroot",ppp,iii,sep="")
  ...
  cat(paste("\n$('#",data.id,"').html('<pre>' + data + '</pre>');",sep=""),file=js.file.name.unitroot,append=T)
...
#unit root test graphimage
  ...
  dev.off()
  #output rootunit js  
  cat(paste("document.write('<div id=\"",data.id,"\"></div>\');\n",sep=""),file=js.file.root.list,append=T)
...
if(ppp==1 && chk.acf==0){  
  acf.html<-paste(js.title[[iii]],"acf",id,".html",sep="")
...
#javascript part for acf       
tmp.acf<-dataset[[obj[iii]]]
png.file<-paste("acf",id,ppp,iii,".png",sep="")
png(file=png.file,width=1400,height=1200) 
par(mar=c(9, 7, 15, 4))
...
if(ppp==1 && chk.forecast==0){  
  forecast.html<-paste(js.title[[iii]],"forecast",id,".html",sep="")
...
#javascript part for forecast
#future
tmp.forecast<-na.omit(dataset[[obj[iii]]]) 
forecast.interval<-floor(length(tmp.forecast[,2])/10)
png.file<-paste("forecastfuture",id,ppp,iii,".png",sep="")
png(file=png.file,width=1400,height=1200) 
par(mar=c(5, 7, 15, 4))
par(cex.main=4,cex.lab=2,cex.axis=2)
if(monthly==1){
...
png.file<-paste("forecasttest",id,ppp,iii,".png",sep="")
png(file=png.file,width=1400,height=1200) 
par(mar=c(5, 7, 18, 4))
par(cex.main=4,cex.lab=2,cex.axis=2)
...
#javascript part
if(ppp==1 && chk.forecast==0){  
  return.html<-paste(js.title[[iii]],"return",id,".html",sep="")
...
png.file<-paste("return",id,ppp,iii,".png",sep="")
png(file=png.file,width=1400,height=1200) 
plot(g)
dev.off()
cat(paste("<img src=\"http://archive.am-consulting.co.jp/",png.file,add.ver,"\"", " alt=\"\" width=\"100%\">\n",sep=""),file=return.html,append=T) 
tmp.data<-tmp.fitting.return[,2]      
png.file<-paste("returnqq",id,ppp,iii,".png",sep="")
png(file=png.file,width=1400,height=1200) 
par(mar=c(5, 5, 14, 2))      
qqnorm(tmp.data,main=paste("Normal Q-Q Plot Return of",colnames(tmp.fitting)[2],"\nfrom ",date.f," to ",date.e,"\nShapiro Test:p-value=",shapiro.test(tmp.data)$p.value),cex.main=5,cex.legend=3,cex.lab=2,cex.axis=3)
qqline(tmp.data,col="2",lwd="5") 
dev.off()
cat(paste("<img src=\"http://archive.am-consulting.co.jp/",png.file,add.ver,"\"", " alt=\"\" width=\"100%\">\n",sep=""),file=return.html,append=T) 
png.file<-paste("returnecdf",id,ppp,iii,".png",sep="")
png(file=png.file,width=1400,height=1200)
par(mar=c(5, 5, 14, 2))     
plot(ecdf(tmp.data),main=paste("Empirical distribution\nReturn of ",colnames(tmp.fitting)[2],"\nfrom ",date.f," to ",date.e),cex.main=5,cex.legend=3,cex.lab=2,cex.axis=3)      
dev.off()
cat(paste("<img src=\"http://archive.am-consulting.co.jp/",png.file,add.ver,"\"", " alt=\"\" width=\"100%\">\n",sep=""),file=return.html,append=T) 
######################################returnfitting ######################################    
######################################  returnrank  ######################################
...
for(rrrr in 1:3){      
  if(rrrr==1){
    ...
    rank.title=paste("Top 10 of Return:Plunge",colnames(tmp.fitting)[2],"\nfrom ",date.f," to ",date.e)
  }else if(rrrr==2){
    tmp.return.rank.table.plot<-tail(tmp.return.rank.table,10)
    rank.title=paste("Top 10 of Return:Jump",colnames(tmp.fitting)[2],"\nfrom ",date.f," to ",date.e)
  }else{
    tmp.return.rank.table.plot<-tmp.fitting.return
    rank.title=paste("Time Series of Return",colnames(tmp.fitting)[2],"\nfrom ",date.f," to ",date.e)
  }  
  png.file<-paste("rank",id,ppp,iii,rrrr,".png",sep="")
  png(file=png.file,width=1400,height=1200)       
  ...
  g<-g+theme(plot.title=element_text(size=70))
  g<-g+theme(axis.title.x=element_text(size=40),axis.title.y=element_text(size=40)) 
  g<-g+theme(axis.text.x=element_text(size=40),axis.text.y=element_text(size=40)) 
...
if(ppp==1 && chk.garch==0){  
  garch.html<-paste(js.title[[iii]],"garch",id,".html",sep="")
