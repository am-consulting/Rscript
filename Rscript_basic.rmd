...
ts.source[[2]]<-c("FRED",1,"DTWEXM","DEXJPUS","DEXUSEU","DEXUSUK","DEXUSAL","DEXNOUS","DEXSZUS","DEXSFUS","DEXKOUS","DEXUSNZ","DEXCHUS")
...
buf<-all.data.xts[[1]][,c(1:4,6,9,10,12,29,30)]
...
buf<-all.data.xts[[1]][,c(1:18,29:30)]
buf<-na.omit(buf[paste(first.date,"::",sep="")])
for(iii in 1:2){
  grand.result<-NULL
  if(iii==1){  
