...
#output png
    ...
    png(file=png.file,width=1400,height=1200)
    par(mar=c(8, 8, 8, 8))
    chart.TimeSeries(tmp.0[,1],main=paste(currency[iii],"\n",first(index(tmp.0)),"-",last(index(tmp.0))),yaxis.right=F,type="h",lwd="2",legend.loc="bottomleft",color="black",cex.main=4,cex.legend=4,cex.lab=4,cex.axis=4)
    par(new=T)
    chart.TimeSeries(tmp.0[,2],main="",type="o",lwd="2",color="blue",xaxis=F,yaxis.right=T,legend.loc="topleft",cex.legend=4,ylab="",cex.axis=4)
    dev.off()
#output html
