...
if(buf.dataset[1,1]<=as.Date("1989-04-01")){
  ...
  g<-g+geom_text(aes(x=as.Date("1989-04-01"), y=value.y*0.9, label="1989年4月-消費税導入(3%)"), size=8,family="Meiryo",colour="black") 
}
if(buf.dataset[1,1]<=as.Date("1997-04-01")){
  ...
  g<-g+geom_text(aes(x=as.Date("1997-04-01"), y=value.y*0.9, label="1997年4月-消費税増税(3%→5%)"), size=8,family="Meiryo",colour="black") 
}
