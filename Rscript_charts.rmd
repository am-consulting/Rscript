...
mainTitle<-"対外及び対内証券投資売買契約等の状況(億円) - "#"対外及び対内証券投資売買契約等の状況(億円) - "#"週間石油在庫統計 - "
dataSource<-"\nData Source:財務省"#Hellenic Statistical Authority"#"\nData Source:財務省"#"\nData Source:U.S. Energy Information Administration"
