...
if(buf.dataset[1,1]<=as.Date("2013-01-01")){
  ...
  g<-g+geom_text(aes(x=as.Date("2013-01-01"), y=value.y*1.1, label="2013年1月(2012/12/26)\n第二次安倍政権発足"), size=8,family="Meiryo",colour="black") 
}
if(buf.dataset[1,1]<=as.Date("2009-09-01")){
  ...
  g<-g+geom_text(aes(x=as.Date("2009-09-01"), y=value.y*1.1, label="2009年9月(2009/9/16)\n民主党政権発足"), size=8,family="Meiryo",colour="black") 
}
}  
#消費税パート  
