...
amchartsObj<-c("NIKKEI225","DEXJPUS","GOLDAMGBD228NLBM","DCOILWTICO","DJIA")
...
cat("},\n",file=htmlFile,append=T)  
cat("\"graphs\": [\n",file=htmlFile,append=T)
for(ccc in 2:length(forAmcahrts)){
cat("{\n",file=htmlFile,append=T) 
cat(paste("\"id\": \"g",ccc,"\",\n",sep=""),file=htmlFile,append=T) 
cat("\"bullet\": \"round\",\n",file=htmlFile,append=T) 
...
cat(paste("\"balloonText\": \"<div style='margin:5px; font-size:19px;'><span style='font-size:13px;'>",colnames(forAmcahrts)[ccc],"</span><br>[[value]]</div>\"\n",sep=""),file=htmlFile,append=T)
