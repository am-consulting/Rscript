...
png.file<-"earthquakejapan01.png"
png(file=png.file,width=1400,height=1200) 
plot(japan.map.1)
dev.off()
#map html
cat("地震マップ\n",file=output.html,append=F)   
...
png.file<-"earthquakejapan02.png"
...
for(ppp in 1:4){ 
  ...
  cat("ヒストグラム-",hist.sub,file=output.html,append=T)   
  cat(paste("<img src=\"http://archive.am-consulting.co.jp/",png.file,add.ver,"\"", " alt=\"\" width=\"100%\">\n",sep=""),file=output.html,append=T)   
  cat("\n<hr>\n\n",file=output.html,append=T) 
}
#earthquake table
...
js.file.name<-"earthquakejapan.js"
