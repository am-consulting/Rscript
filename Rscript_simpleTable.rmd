...
cat("</div>\n",file=htmlFile,append=T)
cat("Powered by<br>-DataTables( http://datatables.net/ )<br>",file=htmlFile,append=T)  
cat("-jQuery Sparklines( http://omnipotent.net/jquery.sparkline/#s-about )",file=htmlFile,append=T)  
