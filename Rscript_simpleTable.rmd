...
cat("<style>\n",file=htmlFile,append=T)
cat("table{width:100%;border-collapse:collapse;padding:0;border-spacing:1;margin-left: auto;margin-right: auto;font-size:",tablefontsize,"%;}\n",file=htmlFile,append=T)
...
cat("</div>\n",file=htmlFile,append=T)
cat("Powered by<br>-DataTables( http://datatables.net/ )",file=htmlFile,append=T)  
if(needsparkline==1){
