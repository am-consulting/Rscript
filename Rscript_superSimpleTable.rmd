...
needLinktable<-1  # 1 or other number
individualPage<-0 # 1 or other number
RegularObj<-c(2)
title<-"東京都の人口(推計)-区市町村別主要10か国外国人人口-2016年1月1日現在"
source<-"東京都"
...
htmlFile<-paste("superSimpleTable_",floor(as.numeric(ST)),".html",sep="")
