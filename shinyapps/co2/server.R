...
shinyServer(function(input, output, session)
{
  ...
  output$remarktext <- renderUI({
    ...
    <li><a href=\"http://ds.data.jma.go.jp/ghg/kanshi/obs/co2_monthave_ryo.html\" target=\"_blank\">Raw Data Source</a></li>
    </ol>"
    HTML(str)
  })
  ...
  output$gitcode <- renderUI({
    ...
    <b>Code</b><br>
    <ol>
    <li><a href=\"https://github.com/am-consulting/Rscript/tree/master/shinyapps/co2\" target=\"_blank\">Move to GitHub</a></li>
    </ol>"
    HTML(str)
  })
