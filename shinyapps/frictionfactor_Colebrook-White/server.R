...
shinyServer(function(input, output, session)
{
  ...
  output$history <- renderUI({
    ...
    <li>2016-06-21:ver.1.0.2</li>
    <li>2016-07-06:ver.1.0.3</li>
    </ol>"
    HTML(str)
  })
  ...
  output$gitcode <- renderUI({
    ...
    <b>Code</b><br>
    <ol>
    <li><a href=\"https://github.com/am-consulting/Rscript/tree/master/shinyapps/frictionfactor_Colebrook-White\" target=\"_blank\">Move to GitHub</a></li>
    </ol>"
    HTML(str)
  })
