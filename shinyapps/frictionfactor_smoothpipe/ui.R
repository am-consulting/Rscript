...
# favicon    
  ...
  headerPanel(
    "Calculation of Loss coefficient for straight pipe(λ , friction factor):Smooth pipe"
  ),
  fluidRow(column(
    12,
    withMathJax(
      "$$\\text{Smooth pipe } \\frac {1}{ \\sqrt{\\lambda}}=2\\times \\log_{10}(Re\\times\\sqrt{\\lambda})  -0.8$$"
      ,
