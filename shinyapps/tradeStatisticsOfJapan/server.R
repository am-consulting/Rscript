...
shinyServer(function(input, output, session)
{
  ...
  output$gitcode <- renderUI({
    ...
    <b>Code</b><br>
    <ol>
    <li><a href=\"https://github.com/am-consulting/Rscript/tree/master/shinyapps/tradeStatisticsOfJapan\" target=\"_blank\">Move to GitHub</a></li>
    </ol>"
    HTML(str)
  })
